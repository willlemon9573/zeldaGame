...
namespace SprintZero1.Managers
{
    internal static class ControlsManager
    {
        ...
        public static void CreateKeyboardControlsMap(string controllerSettingsPath, IEntity player, Game1 game)
        {
            ...
            _playerKeyboardControlsMap.Add(player, controllerParser.ParseKeyboardControls(KEYBOARD_ELEMENT, (ICombatEntity)player, game));
        }
        ...
        /// <param name="gameState">The current state of the game</param>
        public static void CreateGamePadControlsMap(string controllerSettingsPath, IEntity player, Game1 game)
        {
            XDocument controllerDocument = XDocument.Load(controllerSettingsPath);
            PlayerControlsParser controlsParser = new PlayerControlsParser(controllerDocument, ROOT_NAME);
            _playerGamePadControlsMap.Add(player, controlsParser.ParseGamePadControls(GAMEPAD_ELEMENT, (ICombatEntity)player, game));
        }
        ...
        {
            _playerKeyboardControlsMap.Clear();
        }
