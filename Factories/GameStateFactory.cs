...
namespace SprintZero1.Factories
{
    ...
    {
        private static Dictionary<GameState, Func<IGameState>> _gameStateMap;
        ...
        {
            _gameStateMap = new Dictionary<GameState, Func<IGameState>>()
            {
        ...
        {
            return _gameStateMap[newState].Invoke();
        }
    }
}
